...
class ViewActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        copy.setOnClickListener {
            Toast.makeText(this@ViewActivity, "${heading.text} কপি করা হয়েছে", Toast.LENGTH_SHORT).show()
        ...
        heading.isFocusableInTouchMode = true
        heading.requestFocus()
        heading.setSelected(true)
        writer.isFocusable = true
        writer.isFocusableInTouchMode = true
        writer.requestFocus()
        writer.setSelected(true)
        val sharedPreferences = getSharedPreferences("MyPrefs", MODE_PRIVATE)
        val nameText = sharedPreferences.getString("name", "No name provided")
        val authorText = sharedPreferences.getString("author", "No author available")
